...
export const apply = async (_prevState: any, formData: FormData) => {
    // EurekaHACKS 2025 is over and the database is offline, so applications can no longer be stored.
    return {
        error: "Applications are closed. EurekaHACKS 2025 has concluded.",
        payload: formData,
    };
