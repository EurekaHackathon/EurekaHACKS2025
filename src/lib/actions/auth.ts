...
export const logout = async (prevState: any, formData: FormData) => {
    ...
    if (sessionCookie) {
        // EurekaHACKS 2025 is over and the database is offline, so there is no session row to delete.
        // Clearing the cookie is enough to sign the browser out.
        // try {
...
export const loginWithEmail = async (prevState: any, formData: FormData) => {
    // EurekaHACKS 2025 is over and the database is offline, so accounts can no longer be looked up.
    return {error: "Login is closed. EurekaHACKS 2025 has concluded and hacker accounts have been archived."};
...
export const signUpWithEmail = async (prevState: any, formData: FormData) => {
    // EurekaHACKS 2025 is over and the database is offline, so accounts can no longer be created.
    return {
        error: "Registration is closed. EurekaHACKS 2025 has concluded.",
        payload: formData,
    };
...
export const resendEmailVerificationLink = async (prevState: any, formData: FormData): Promise<{
    error?: string,
    success?: boolean
}> => {
    // EurekaHACKS 2025 is over and the database is offline, so verification emails are no longer sent.
    return {error: "Email verification is closed. EurekaHACKS 2025 has concluded."};
...
export const requestPasswordReset = async (prevState: any, formData: FormData) => {
    // EurekaHACKS 2025 is over and the database is offline, so reset tokens can no longer be issued.
    return {error: "Password resets are unavailable. EurekaHACKS 2025 has concluded and hacker accounts have been archived."};
...
export const resetPassword = async (prevState: any, formData: FormData) => {
    // EurekaHACKS 2025 is over and the database is offline, so passwords can no longer be changed.
    return {error: "Password resets are unavailable. EurekaHACKS 2025 has concluded and hacker accounts have been archived."};
