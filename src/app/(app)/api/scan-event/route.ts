...
export async function POST(request: Request) {
    // EurekaHACKS 2025 is over and the database is offline, so check-ins can no longer be recorded.
    return new Response("Event check-in is closed. EurekaHACKS 2025 has concluded.", {status: 503});
