...
export async function POST(request: Request) {
    // EurekaHACKS 2025 is over and the database is offline, so application statuses can no longer be changed.
    return new Response("Applications are closed. EurekaHACKS 2025 has concluded.", {status: 503});
